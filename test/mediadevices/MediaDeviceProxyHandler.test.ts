...
import MediaDeviceProxyHandler from '../../src/mediadevices/MediaDeviceProxyHandler';
...
describe('MediaDeviceProxyHandler', () => {
  ...
  beforeEach(() => {
    ...
    mediaDeviceWrapper = new Proxy<MediaDevices>(navigator.mediaDevices, new MediaDeviceProxyHandler())
  });
  ...
  describe('Not using MediaDevices.ondevicechange', () => {
    ...
    it('receives an event if a device list changes', async () => {
      ...
      let callCount2 = 0;
      let callCount3 = 0;
      const listener1 = () => { callCount1 += 1; };
      const listener2 = () => { callCount2 += 1; };
      const listener3 = () => { callCount3 += 1; };
      domMockBehavior.enumerateDeviceList = [
        getMediaDeviceInfo('1', 'audioinput', 'label'),
        getMediaDeviceInfo('2', 'videoinput', 'label'),
        getMediaDeviceInfo('3', 'audiooutput', 'label'),
